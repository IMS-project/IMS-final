...
<head>
    ...
    <title>Internshipmanagement | Registration Page</title>
...
<div class="col-md-6">
 <div><input id="female" type="radio"class="form-control" name="sex" value="Female" {{ (old('sex') == 'female') ? 'checked' : '' }} >Female</div>
